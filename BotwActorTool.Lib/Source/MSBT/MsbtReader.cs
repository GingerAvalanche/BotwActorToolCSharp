using BotwActorTool.Lib.MSBT.Sections;
using System.Text;
...
namespace BotwActorTool.Lib.MSBT
{
    class MsbtReader
    {
        ...
        public Header ReadHeader()
        {
            ...
            if (magic != MSBT.HEADER_MAGIC) {
                throw new MsbtException.InvalidMagicException(Encoding.UTF8.GetString(magic));
            }

            Endianness endianness = reader.ReadU16(Endianness.Little) switch {
                65279 => Endianness.Big,
                65534 => Endianness.Little,
        ...
        public Atr1 ReadAtr1()
        {
            ...
            return new Atr1(section, string_count, _unknown_1, strings);
        }
        ...
        public Txt2 ReadTxt2()
        {
            ...
            return new Txt2(section, string_count, strings);
        }
