using BotwActorToolLib.Gamedata.Flags;
using ByamlExt.Byaml;
using System.Collections.Generic;
using System.Collections.ObjectModel;
using System.Linq;

namespace BotwActorToolLib.Gamedata
{
    public class Store
    {
        ...
        public Store() { }
        public void AddFlagsFromByml(string filename, OrderedDictionary<string, dynamic> byml)
        {
            bool IsRevival = filename.Contains("revival");
            foreach (KeyValuePair<string, List<OrderedDictionary<string, dynamic>>> pair in byml)
            {
                foreach (OrderedDictionary<string, dynamic> flag in pair.Value)
                {
        ...
        public void AddFlagsFromBymlNoOverwrite(string filename, OrderedDictionary<string, dynamic> byml)
        {
            bool IsRevival = filename.Contains("revival");
            foreach (KeyValuePair<string, List<OrderedDictionary<string, dynamic>>> pair in byml)
            {
        ...
        public void Add(string type, BaseFlag flag)
        {
            FlagStore[type][flag.HashValue] = flag;
        }
        public void Remove(string type, int hash)
        {
            FlagStore[type].Remove(hash);
        }
        ...
        public List<OrderedDictionary<string, dynamic>> ToSvdata()
        {
            List<OrderedDictionary<string, dynamic>> ret = new();
